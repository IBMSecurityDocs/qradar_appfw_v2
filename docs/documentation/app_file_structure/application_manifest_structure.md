...
<table>
    ...
    <tbody>
        ...
        <tr>
            ...
            <td>No</td>
            <td>Boolean</td>
            <td>Set to false if you don’t want to add a user role setting for your app. This flag is available for QRadar version 7.5.0 UP4 and later. It is ignored in previous versions.
                </br>
