# QRadar app base image 2.1.23 packages

This page shows every package installed in `qradar-app-base` image version `2.1.23`.

## Python packages

These are the `2.1.23` packages listed by the `pip list` command.
...
These are the `2.1.23` packages listed by the `rpm -qa` command.
...
<table>
    ...
    <tbody>
      ...
      <tr>
        <td>python36</td>
        <td>3.6.8-39.module+el8.10.0+20784+edafcd43</td>
