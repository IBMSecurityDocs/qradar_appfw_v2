# QRadar app base image 3.0.0 packages

This page shows every package installed in `qradar-app-base` image version `3.0.0`.

## Python packages

These are the `3.0.0` packages listed by the `pip list` command.
...
These are the `3.0.0` packages listed by the `rpm -qa` command.
